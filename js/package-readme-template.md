[//]: # (Replace all occurrences of 'your_package', 'your_package_desription' and 'your_username'. Pick one of the Version informartion texts. Leave the comment as it is used to auto-update that part.)
